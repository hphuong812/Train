...
namespace IsoMatrix.Scripts.Utilities
{
    ...
    [AddComponentMenu("Cinemachine/TrainPath")]
    [SaveDuringPlay]
    [DisallowMultipleComponent]
    public class TrainPath : TrainPathBase
    {
        ...
        public float GetRoll(int indexA, int indexB, float standardizedPos)
        {
            if (indexA == indexB)
